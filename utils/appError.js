...
class AppError extends Error {
   ...
   Error.captureStackTrace(this, this.constructor) //when a new object is created and a constructor functio is called den dat function call would not appear in the stack or pollute it 
}
}
